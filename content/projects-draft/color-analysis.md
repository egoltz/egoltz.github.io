---
title: "Rothko's Color"
description: "Began as a program for Website color usage, I reused my code to analyze Mark Rothko's use of color over the course of his lifetime."
thumbnail: "/images/projects/thumbnail-rothko.png"
...
![Rothko Color Field](/images/rothko-colorbars-1.png)
...
![Rothko Analysis](/images/rothko-analysis.png)
...
![Rothko All Paintings](/images/rothko-colorbars.png)

## Original Color Breakdown Code
I originally created this to help with website color analysis for UI/UX research. But I had the idea to use in the art realm when viewing a painting by John Singer Sargent, 'Man with Laurels', from the Los Angeles County Museum of Art Permanent Collection. This painting has always been interesting to me because it conveys so much with such a limited palette. Contrast to Rothko's abstract minimalism, where color is the primary vehicle for expression.
![Orginal Image](/images/sargent-painting.png)

![Horizontal Stacked Bar Chart](/images/color-bar.png)

Color breakdown by hex code and pixel count:

![Color Hex Codes](/images/color.png)
